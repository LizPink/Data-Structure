...
{
    Vector<int> vec{5};
    vec.insert(0,1); vec.insert(1,2); vec.insert(2,2); vec.insert(3,3); vec.insert(4,3); vec.insert(5,5); vec.insert(6,7);
    std::cout << "binary_search_a\n" << vec.binary_search_a(3,0,7) << std::endl;
    std::cout << "binary_search_b\n" << vec.binary_search_b(3,0,7) << std::endl;
    std::cout << "binary_search_b\n" << vec.binary_search_b(1,0,7) << std::endl;
    std::cout << "binary_search_b\n" << vec.binary_search_b(0,0,7) << std::endl;
    return 0;
}
template <typename T>
